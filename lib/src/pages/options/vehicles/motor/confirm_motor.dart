...
class ConfirmMotorListing extends StatelessWidget {
  final Token token;
  final Bodytypesmotor bodytypeSeleted;
  final String averageDimensions;
  final String averageWeight;
  final Listing listingCreated;

  const ConfirmMotorListing({
    Key? key,
                  ...
                  child: InteractiveViewer(
                    ...
                    child: Container(
                        ...
                        child: FadeInImage(
                          ...
                          image: AssetImage(
                              "assets/motorbodytypes/${bodytypeSeleted.image}"),
                        )),
                  ),
                ),
              ],
